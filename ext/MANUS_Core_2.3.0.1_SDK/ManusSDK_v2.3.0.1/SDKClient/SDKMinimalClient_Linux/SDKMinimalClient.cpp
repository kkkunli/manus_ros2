...
ClientReturnCode SDKMinimalClient::Connect()
{
	...
	{
		std::cout << "Failed to find hosts. Reason: start failed." << std::endl;
	...
	{
		std::cout << "Failed to find hosts. Reason: number failed." << std::endl;
		return ClientReturnCode::ClientReturnCode_FailedToFindHosts;
	}

	if (t_NumberOfHostsFound == 0)
	{
		std::cout << "Failed to find hosts. Reason: no hosts found." << std::endl;
		return ClientReturnCode::ClientReturnCode_FailedToFindHosts;
	}
	...
	{
		std::cout << "Failed to find hosts. Reason: get hosts failed." << std::endl;
		return ClientReturnCode::ClientReturnCode_FailedToFindHosts;
	}
	...
	{
		std::cout << "Failed to connect to host. Reason: not connected." << std::endl;
